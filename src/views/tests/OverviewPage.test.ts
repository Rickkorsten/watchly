...
describe('OverviewPage.vue', () => {
  ...
  it('renders show list when data is loaded', () => {
    (useShowsByGenre as ReturnType<typeof vi.fn>).mockReturnValue({
      data: ref({
        Anime: [
          { id: 1, name: 'Naruto', image: { original: 'https://example.com/naruto.jpg' }, rating: { average: 8.7 } },
        ],
        Comedy: [
          { id: 2, name: 'Brooklyn Nine-Nine', image: { original: 'https://example.com/b99.jpg' }, rating: { average: 8.3 } },
        ],
      }),
      isLoading: ref(false),
      error: ref(null),
